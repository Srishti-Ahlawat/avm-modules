...
### <a name="application_groups"></a> [virtual\_desktop\_application\_group\_application\_groups](#input\_virtual\_desktop\_application\_group\_application\_groups)
Description: (Required) It is a map of all the application groups and their configurations
