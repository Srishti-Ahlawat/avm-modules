...
private_link_services = {
  pls1 = {
    ...
    subnet_id                                   = "/subscriptions/05a4028e-14a9-4f7d-baf3-2629d5a430bc/resourceGroups/new-epac/providers/Microsoft.Network/virtualNetworks/test-vnet112/subnets/default"                            # "<subnet_id>"
    ...
    lb_resource_group                           = "new-epac"     # <-- Add this attribute if needed
    loadbalancer_name                           = "mttest002"    # <-- Add this attribute if needed
    location                                    = "East US"      # <-- Add this attribute if needed
    networking_resource_group                   = "new-epac"     # <-- Add this attribute if needed
    pls_resource_group                          = "new-epac"     # <-- Add this attribute if needed
    subnet_name                                 = "default"      # <-- Add this attribute if needed
    vnet_name                                   = "test-vnet112" # <-- Add this attribute if needed
  }
}
